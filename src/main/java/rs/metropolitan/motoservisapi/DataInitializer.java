...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        ServiceRecord sr1 = serviceRecordRepository.save(new ServiceRecord(null, moto1, mechanic1, LocalDate.now(), "Zamena ulja i filtera", 3500.0, ServiceStatus.COMPLETED));
        ServiceRecord sr2 = serviceRecordRepository.save(new ServiceRecord(null, moto2, mechanic2, LocalDate.now(), "Dijagnostika elektrike", 2000.0, ServiceStatus.IN_PROGRESS));
